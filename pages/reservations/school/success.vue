...
import ReservationSuccess from '@/components/reservations/formtypes/escolar/ReservationSuccess.vue'
...
const { store, clearPersistence } = useReservationSchool()
...
const handleDownload = (reservationData) => {
  ...
  downloadPDF(pdfContent, `reservacion-escolar-${reservationData?.id || 'confirmacion'}.pdf`)
}
...
onMounted(() => {
  ...
  showSuccess(
    ...
    'Tu reservación escolar ha sido procesada exitosamente'
  )
})
