...
const props = withDefaults(defineProps<DialogContentProps & { class?: HTMLAttributes['class'], isCloseButton?: boolean }>(), {
  isCloseButton: true
})
...
<template>
  <DialogPortal>
    ...
    >
      ...
      >
        <Icon icon="material-symbols:close-rounded" width="20" height="20" class="text-[#1D1D1D]" />
